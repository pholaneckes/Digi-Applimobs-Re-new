...
public class ModelPartFB {
    ...
    private final List<ModelPartFB.Cube> cubes;
    private final Map<String, ModelPartFB> children;
    private PartPose initialPose = PartPose.ZERO;

    public ModelPartFB(List<ModelPartFB.Cube> p_171306_, Map<String, ModelPartFB> p_171307_) {
    ...
    public void copyFrom(ModelPartFB p_104316_) {
    ...
    public ModelPartFB getChild(String p_171325_) {
        ModelPartFB ModelPartFB = this.children.get(p_171325_);
        if (ModelPartFB == null) {
    ...
    public void render(PoseStack p_104307_, VertexConsumer p_104308_, int p_104309_, int p_104310_, float p_104311_, float p_104312_, float p_104313_, float p_104314_) {
        if (this.visible) {
            if (!this.cubes.isEmpty() || !this.children.isEmpty()) {
                ...
                for(ModelPartFB ModelPartFB : this.children.values()) {
                    ModelPartFB.render(p_104307_, p_104308_, p_104309_, p_104310_, p_104311_, p_104312_, p_104313_, p_104314_);
                }
    ...
    public void visit(PoseStack p_171310_, ModelPartFB.Visitor p_171311_) {
        this.visit(p_171310_, p_171311_, "");
    }

    private void visit(PoseStack p_171313_, ModelPartFB.Visitor p_171314_, String p_171315_) {
        if (!this.cubes.isEmpty() || !this.children.isEmpty()) {
            p_171313_.pushPose();
    ...
    private void compile(PoseStack.Pose p_104291_, VertexConsumer p_104292_, int p_104293_, int p_104294_, float p_104295_, float p_104296_, float p_104297_, float p_104298_) {
        for(ModelPartFB.Cube modelpart$cube : this.cubes) {
            modelpart$cube.compile(p_104291_, p_104292_, p_104293_, p_104294_, p_104295_, p_104296_, p_104297_, p_104298_);
        }

    }

    public ModelPartFB.Cube getRandomCube(RandomSource p_233559_) {
    ...
    public Stream<ModelPartFB> getAllParts() {
        return Stream.concat(Stream.of(this), this.children.values().stream().flatMap(ModelPartFB::getAllParts));
    }

    @OnlyIn(Dist.CLIENT)
    public static class Cube {
        private final ModelPartFB.Polygon[] polygons;
        ...
        public Cube(int p_273701_, int p_273034_, float p_272824_, float p_273777_, float p_273748_, float p_273722_, float p_273763_, float p_272823_, float p_272945_, float p_272790_, float p_272870_, boolean p_273589_, float p_273591_, float p_273313_, Set<Direction> p_273291_) {
            ...
            this.polygons = new ModelPartFB.Polygon[p_273291_.size()];
            ...
            ModelPartFB.Vertex modelpart$vertex7 = new ModelPartFB.Vertex(p_272824_, p_273777_, p_273748_, 0.0F, 0.0F);
            ModelPartFB.Vertex modelpart$vertex = new ModelPartFB.Vertex(f, p_273777_, p_273748_, 0.0F, 8.0F);
            ModelPartFB.Vertex modelpart$vertex1 = new ModelPartFB.Vertex(f, f1, p_273748_, 8.0F, 8.0F);
            ModelPartFB.Vertex modelpart$vertex2 = new ModelPartFB.Vertex(p_272824_, f1, p_273748_, 8.0F, 0.0F);
            ModelPartFB.Vertex modelpart$vertex3 = new ModelPartFB.Vertex(p_272824_, p_273777_, f2, 0.0F, 0.0F);
            ModelPartFB.Vertex modelpart$vertex4 = new ModelPartFB.Vertex(f, p_273777_, f2, 0.0F, 8.0F);
            ModelPartFB.Vertex modelpart$vertex5 = new ModelPartFB.Vertex(f, f1, f2, 8.0F, 8.0F);
            ModelPartFB.Vertex modelpart$vertex6 = new ModelPartFB.Vertex(p_272824_, f1, f2, 8.0F, 0.0F);
            ...
            if (p_273291_.contains(Direction.DOWN)) {
                this.polygons[i++] = new ModelPartFB.Polygon(new ModelPartFB.Vertex[]{modelpart$vertex4, modelpart$vertex3, modelpart$vertex7, modelpart$vertex}, f5, f10, f6, f11, p_273591_, p_273313_, p_273589_, Direction.DOWN);
            }

            if (p_273291_.contains(Direction.UP)) {
                this.polygons[i++] = new ModelPartFB.Polygon(new ModelPartFB.Vertex[]{modelpart$vertex1, modelpart$vertex2, modelpart$vertex6, modelpart$vertex5}, f6, f11, f7, f10, p_273591_, p_273313_, p_273589_, Direction.UP);
            }

            if (p_273291_.contains(Direction.WEST)) {
                this.polygons[i++] = new ModelPartFB.Polygon(new ModelPartFB.Vertex[]{modelpart$vertex7, modelpart$vertex3, modelpart$vertex6, modelpart$vertex2}, f4, f11, f5, f12, p_273591_, p_273313_, p_273589_, Direction.WEST);
            }

            if (p_273291_.contains(Direction.NORTH)) {
                this.polygons[i++] = new ModelPartFB.Polygon(new ModelPartFB.Vertex[]{modelpart$vertex, modelpart$vertex7, modelpart$vertex2, modelpart$vertex1}, f5, f11, f6, f12, p_273591_, p_273313_, p_273589_, Direction.NORTH);
            }

            if (p_273291_.contains(Direction.EAST)) {
                this.polygons[i++] = new ModelPartFB.Polygon(new ModelPartFB.Vertex[]{modelpart$vertex4, modelpart$vertex, modelpart$vertex1, modelpart$vertex5}, f6, f11, f8, f12, p_273591_, p_273313_, p_273589_, Direction.EAST);
            }

            if (p_273291_.contains(Direction.SOUTH)) {
                this.polygons[i] = new ModelPartFB.Polygon(new ModelPartFB.Vertex[]{modelpart$vertex3, modelpart$vertex4, modelpart$vertex5, modelpart$vertex6}, f8, f11, f9, f12, p_273591_, p_273313_, p_273589_, Direction.SOUTH);
            }
        ...
        public void compile(PoseStack.Pose p_171333_, VertexConsumer p_171334_, int p_171335_, int p_171336_, float p_171337_, float p_171338_, float p_171339_, float p_171340_) {
            ...
            for(ModelPartFB.Polygon modelpart$polygon : this.polygons) {
                Vector3f vector3f = matrix3f.transform(new Vector3f((Vector3fc)modelpart$polygon.normal));
                float f = vector3f.x();
                float f1 = vector3f.y();
                float f2 = vector3f.z();

                for(ModelPartFB.Vertex modelpart$vertex : modelpart$polygon.vertices) {
    ...
    static class Polygon {
        public final ModelPartFB.Vertex[] vertices;
        public final Vector3f normal;

        public Polygon(ModelPartFB.Vertex[] p_104362_, float p_104363_, float p_104364_, float p_104365_, float p_104366_, float p_104367_, float p_104368_, boolean p_104369_, Direction p_104370_) {
            ...
            if (p_104369_) {
                ...
                for(int j = 0; j < i / 2; ++j) {
                    ModelPartFB.Vertex modelpart$vertex = p_104362_[j];
    ...
    static class Vertex {
        ...
        public ModelPartFB.Vertex remap(float p_104385_, float p_104386_) {
            return new ModelPartFB.Vertex(this.pos, p_104385_, p_104386_);
        }
    ...
    public interface Visitor {
        void visit(PoseStack.Pose p_171342_, String p_171343_, int p_171344_, ModelPartFB.Cube p_171345_);
    }
}
